const footer = `
 <footer
      class="flex flex-col text-white py-10 px-6 box-border font-custom bg-darkGreen mt-10"
    >
      <div class="py-4 flex justify-center">
        <div class="flex flex-col gap-2 pr-10 text-[24px]">
          <img
          ...
          <div class="pb-2">+1 (704) 490-0246<br />info@grotn.com</div>
        ...
        <div class="flex">
          <div class="flex flex-col gap-4 font-semibold text-[24px] px-48">
            <div class="text-bttns">Pages:</div>
            <a href="../index.html">About</a>
            <a href="../index.html">Terms of Service</a>
            <a href="../index.html">Tenant Account</a>
            <a href="../index.html">Landlord Account</a>
          </div>
          <div class="flex flex-col gap-4 font-semibold text-[24px]">
            <div class="text-bttns">Resources:</div>
            <a href="../index.html">Our Code</a>
            <a href="../index.html">Our Site</a>
            <a href="../index.html">Our Plans</a>
          </div>
        </div>
      </div>
      <div class="pt-2 border-t-2 border-white pb-2 text-right">
        <div>GrotN © 2024</div>
      </div>
    </footer>
    `;
